module RExQuad
    ...
    include(joinpath(@__DIR__, "jetson_master", "jetson_master_node.jl"))
    include(joinpath(@__DIR__, "ground_master", "ground_master_node.jl"))
    include(joinpath(@__DIR__, "ground_master", "vicon_listener.jl"))
