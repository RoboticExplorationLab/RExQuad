            ...
            while true
                ...
                if (debug)
                    ...
                    @printf("\tPosition: \t[%1.3f, %1.3f, %1.3f]\n",
                            quad_info.state.pos_x, quad_info.state.pos_y, quad_info.state.pos_z)
                    @printf("\tQuaternion: \t[%1.3f, %1.3f, %1.3f, %1.3f]\n",
                            quad_info.state.quat_w, quad_info.state.quat_x, quad_info.state.quat_y, quad_info.state.quat_z)
                end
