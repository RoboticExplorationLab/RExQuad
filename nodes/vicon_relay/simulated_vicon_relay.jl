module SimulatedViconRelay
    ...
    function main()
        ...
        relay_serial_port = setup_dict["serial"]["relay"]["telemetry_radio"]["serial_port"]
        relay_baud_rate = setup_dict["serial"]["relay"]["telemetry_radio"]["baud_rate"]
        # Launch the relay to send the Vicon data through the telemetry radio
        _vicon_relay() = vicon_relay(zmq_vicon_ip, zmq_vicon_port,
